...
print('\n2 layers (sigmoid activation function):')
nn2_sig_train_accuracy, nn2_sig_test_accuracy = experiment(NN2_Sigmoid())
print('\n3 layers:')
nn3_train_accuracy, nn3_test_accuracy = experiment(NN3())
print('\n4 layers:')
nn4_train_accuracy, nn4_test_accuracy = experiment(NN4())
print('\n4 layers (dropout):')
nn4_drop_train_accuracy, nn4_drop_test_accuracy = experiment(NN4_Dropout())
...
# b) plot training accuracy for sigmoid vs activation (2 layers)
plt.plot(nn2_train_accuracy)
plt.plot(nn2_sig_train_accuracy)
plt.title('training accuracy - ReLU vs Sigmoid (on 2 layers)')
plt.ylabel('accuracy')
plt.xlabel('epoch')
plt.legend(['ReLU', 'Sigmoid'])
plt.show()

# b) plot testing accuracy for sigmoid vs activation (2 layers)
plt.plot(nn2_test_accuracy)
plt.plot(nn2_sig_test_accuracy)
plt.title('testing accuracy - ReLU vs Sigmoid (on 2 layers)')
plt.ylabel('accuracy')
plt.xlabel('epoch')
plt.legend(['ReLU', 'Sigmoid'])
plt.show()

# c) plot training accuracy for dropout vs no dropout (4 layers)
plt.plot(nn4_train_accuracy)
plt.plot(nn4_drop_train_accuracy)
plt.title('training accuracy - No dropout vs dropout (on 4 layers)')
plt.ylabel('accuracy')
plt.xlabel('epoch')
plt.legend(['no dropout', 'dropout'])
plt.show()

# c) plot testing accuracy for dropout vs no dropout (4 layers)
plt.plot(nn4_test_accuracy)
plt.plot(nn4_drop_test_accuracy)
plt.title('testing accuracy - No dropout vs dropout (on 4 layers)')
plt.ylabel('accuracy')
plt.xlabel('epoch')
plt.legend(['no dropout', 'dropout'])
plt.show()
